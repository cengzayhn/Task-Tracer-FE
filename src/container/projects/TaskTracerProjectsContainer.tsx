...
const TaskTracerProjectsContainer: React.FC<TaskTracerProjectsContainerProps> = (props) => {
    ...
    const handleProjectRightClick = (event: React.MouseEvent<HTMLDivElement, MouseEvent>, id: string) => {
    ...
    <React.Fragment>
        ...
        {dummyData.map((data, index) => (
            ...
            <div className='projects-link' onClick={() => handleProjectClick(data.id)} onContextMenu={(e) => handleProjectRightClick(e, data.id)}>
